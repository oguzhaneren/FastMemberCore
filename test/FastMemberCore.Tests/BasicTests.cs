    ...
    public class BasicTests
    {
       [Fact]
        public void BasicReadTest_PropsOnClass()
        {
            ...
            Assert.Equal(null, access[obj, "D"]);
        }
       ...
       [Fact]
        public void TestReaderAllColumns()
        {
            ...
            Assert.Equal("A", table.Columns["A"].ColumnName);
            Assert.Equal("B", table.Columns["B"].ColumnName);
            Assert.Equal("C", table.Columns["C"].ColumnName);
            Assert.Equal("D", table.Columns["D"].ColumnName);

            Assert.Same(typeof(int), table.Columns["A"].DataType);
            Assert.Same(typeof(string), table.Columns["B"].DataType);
            Assert.Same(typeof(byte), table.Columns["C"].DataType);
            Assert.Same(typeof(int), table.Columns["D"].DataType);
            ...
            Assert.Equal(123, table.Rows[0]["A"]);
            Assert.Equal("abc", table.Rows[0]["B"]);
            Assert.Equal((byte)1, table.Rows[0]["C"]);
            Assert.Equal(123, table.Rows[0]["D"]);
            Assert.Equal(456, table.Rows[1]["A"]);
            Assert.Equal("def", table.Rows[1]["B"]);
            Assert.Equal((byte)2, table.Rows[1]["C"]);
            Assert.Equal(DBNull.Value, table.Rows[1]["D"]);
            Assert.Equal(789, table.Rows[2]["A"]);
            Assert.Equal("ghi", table.Rows[2]["B"]);
            Assert.Equal((byte)3, table.Rows[2]["C"]);
            Assert.Equal(789, table.Rows[2]["D"]);
        }
       ...
       [Fact]
        public void TestReaderSpecifiedColumns()
        {
            ...
            Assert.Equal("B", table.Columns[0].ColumnName);
            Assert.Equal("A", table.Columns[1].ColumnName);
            Assert.Equal("D", table.Columns[2].ColumnName);
            Assert.Same(typeof(string), table.Columns[0].DataType);
            Assert.Same(typeof(int), table.Columns[1].DataType);
            Assert.Same(typeof(int), table.Columns[2].DataType);
            ...
            Assert.Equal(3, table.Rows.Count);
            Assert.Equal("abc", table.Rows[0][0]);
            Assert.Equal(123, table.Rows[0][1]);
            Assert.Equal(123, table.Rows[0][2]);
            Assert.Equal("def", table.Rows[1][0]);
            Assert.Equal(456, table.Rows[1][1]);
            Assert.Equal(DBNull.Value, table.Rows[1][2]);
            Assert.Equal("ghi", table.Rows[2][0]);
            Assert.Equal(789, table.Rows[2][1]);
            Assert.Equal(789, table.Rows[2][2]);
